...
const AvailableDonations = () => {
  const { data: donations, isLoading, error } = useQuery<DonationWithDonor[]>({
    queryKey: ["/api/donations?status=available"],
  });
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center mb-8">
          ...
          <Link href="/donations" className="text-primary font-medium hover:underline flex items-center">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <Link href="/donate" className="text-primary font-medium mt-2 inline-block">
