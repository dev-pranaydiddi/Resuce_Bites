      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
            <Button
              asChild
              className="bg-primary hover:bg-primary-dark text-white font-medium px-6 py-6 rounded-md transition-colors"
            >
            ...
            <Button
              asChild
              variant="outline"
              className="bg-white hover:bg-neutral-100 text-primary border-white font-medium px-6 py-6 rounded-md transition-colors"
            >
