...
interface OrganizationCardProps {
  ...
  iconType?: "heart" | "hands" | "home" | "utensils";
}

const OrganizationCard = ({ organization, iconType = "heart" }: OrganizationCardProps) => {
  const getIcon = () => {
    switch (iconType) {
      case "heart":
        return (
    ...
    switch (iconType) {
      case "heart":
        return {
          ...
          text: "text-[hsl(var(--primary-dark))]"
        };
      case "hands":
        return {
          bg: "bg-[hsl(var(--secondary-light))]",
          text: "text-[hsl(var(--secondary-dark))]"
        };
      case "home":
        return {
          bg: "bg-[hsl(var(--accent-light))]",
          text: "text-[hsl(var(--accent-dark))]"
        };
      case "utensils":
        return {
          bg: "bg-[hsl(var(--primary-light))]",
